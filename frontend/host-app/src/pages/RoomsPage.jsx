...
export default function RoomsPage({ t }) {
  const rooms = [
    { title: t.roomPenthouse, img: '/images/room-penthouse-1.jpg', d: t.roomPenthouseDesc },
    { title: t.roomLux, img: '/images/room-lux-1.jpg', d: t.roomLuxDesc },
    { title: t.roomRoyal, img: '/images/room-business-1.jpg', d: t.roomRoyalDesc },
    { title: t.roomStandard, img: '/images/room-standard-1.jpg', d: t.roomStandardDesc }
  ];
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr', lg: '1fr 1fr 1fr 1fr' }, gap: 4 }}>
          {rooms.map((room, i) => (
            <Paper key={i} sx={{ p: 3, bgcolor: 'background.paper', borderRadius: 0, display: 'flex', flexDirection: 'column', height: '100%' }}>
              ...
              <Box sx={{ mt: 'auto' }}>
                <Button variant="contained" fullWidth sx={{ bgcolor: '#c1a37f', color: 'white', borderRadius: 0, boxShadow: 0, '&:hover': { bgcolor: '#a68a64' } }}>
                  {t.learnMore}
                </Button>
              </Box>
            </Paper>
